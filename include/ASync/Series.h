...
namespace tmdb::ASync::TV
{
    ...
    protected:
        ...
        QString m_status = "BLANK_STATUS";
        QString m_tagline = "BLANK_TAGLINE";
        QString m_type = "BLANK_TYPE";
